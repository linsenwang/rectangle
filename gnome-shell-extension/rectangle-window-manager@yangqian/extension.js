...
const SHORTCUTS = [
    ...
    { name: 'rect-snap-left', handler: 'snapLeft' },
    { name: 'rect-snap-right', handler: 'snapRight' },
    ...
    { name: 'rect-left-third', handler: 'leftThird' },
    { name: 'rect-right-third', handler: 'rightThird' },
